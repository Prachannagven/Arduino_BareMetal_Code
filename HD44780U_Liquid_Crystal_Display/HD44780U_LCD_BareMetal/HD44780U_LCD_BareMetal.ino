...
int pins[11] = {D0, D1, D2, D3, D4, D5, D6, D7, EN, RW, RS};

uint16_t command = 0b00000000000;
...
void setup() {
  ...
  command = (0b0001 << 7) | (0x1f);   //Setting the initial position of the cursor. Each line has up to 16 spaces to write characters in. Addresses in first line go from 0x00 to 0x27 and second line are from 0x40 to 0x67.
  writeDigital(command);
  upload();
